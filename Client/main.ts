import { Order, Product } from "./classes";


let productsssstest: Array<Product> = [
    {
        code: 11,
        name: "hajsdkhasdkja",
            ...
            for (const lineItem of ordervuoto.orderLineItems) {
                ...
                button.addEventListener('click', () => {
                    ...
                    if (existingProductElement) {
                        ...
                        let tcm: number = lineItem.product.price * currentQuantity
...
//popolare un order
function setOrder(productsssstest: any[]) {
